...
export const metadata: Metadata = {
  title:
    "Be a product engineer - Jourdan Bul-lalayao",
  description:
...
const Post = () => (
  <div className="flex flex-col gap-6">
    ...
    <Text>
      It’s a bit cliche - product engineers aren’t a new thing. Companies like <Link href="https://posthog.com/">PostHog</Link> hire specifically for them. Engineers at companies like <Link href="https://angellist.com/" target="_blank">AngelList</Link> have moved up from IC roles into product leadership roles. But what’s different today are the suite of AI tools that are available for engineers to be closer to their product and help shape the vision that companies need to build for success. 
    </Text>

    <Text>
      I was inspired to share my thoughts because AI has helped me think about my work not just from an engineering perspective but also with a product lens. Prototyping tools like the <Link href="https://replit.com/" target="_blank">Replit</Link> agent and Vercel’s <Link href="https://v0.dev/" target="_blank">v0</Link> have made it easy to put a basic web prototype together for the purposes of gathering feedback from users, communicating business requirements and UI/UX ideas with designers, and ultimately learning what is possible with the product I’m trying to build. And this is really just the tip of the iceberg. Never have I felt more powerful and product-knowledgable as an engineer. 
    </Text>
